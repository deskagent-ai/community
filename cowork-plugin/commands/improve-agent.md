...
```
fs_read_file("agents//{{INPUT.agent_name}}.md")
```

Falls nicht gefunden, System-Agents:
```
fs_read_file("deskagent//agents/{{INPUT.agent_name}}.md")
```
...
```python
fs_write_file("agents//{{INPUT.agent_name}}.md", "[kompletter neuer Agent-Inhalt]")
```

Falls der Agent im System-Ordner liegt:
```python
fs_write_file("deskagent//agents/{{INPUT.agent_name}}.md", "[kompletter neuer Agent-Inhalt]")
```
