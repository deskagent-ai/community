...
Taeglicher Ueberblick ueber Termine, offene Punkte und Support-Tickets.
...
5. **Support-Tickets** (falls UserEcho verfuegbar)
...
### Support-Tickets
| # | Alter | Betreff | Status |
|:--|:------|:--------|:-------|

**WICHTIG:** Nur Tickets anzeigen die JUENGER als 100 Tage sind!
Tickets aelter als 100 Tage sind veraltet und werden ignoriert.

*(Falls UserEcho nicht verfuegbar: "UserEcho nicht konfiguriert")*
*(Falls alle Tickets aelter als 100 Tage: "Keine aktuellen Tickets.")*

---
### Jetzt erledigen:
1. **[Typ]** - [Konkrete Aufgabe] ([Zeitangabe])

*Max 5 Punkte. Prioritaet: ZUKUENFTIGE Termine heute -> Angebote -> Aelteste Todos -> Tickets (nur < 100 Tage)*
*Vergangene Termine (Startzeit < aktuelle Uhrzeit) NICHT anzeigen!*
*Tickets aelter als 100 Tage NICHT in die Prioritaetenliste aufnehmen!*
...
---
Termine: X | Angebote: X | Rechnungen: X | Follow-ups: X | Tickets: X
```
