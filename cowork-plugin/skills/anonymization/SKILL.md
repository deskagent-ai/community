...
```json
{
  ...
  "known_persons": [],
  "known_companies": ["My Company GmbH"]
}
```
...
**Example Problem:**
- "mycompany.com" detected as domain → `[DOMAIN-1]`
- AI doesn't know what product you're talking about

**Solution:** Add to whitelist → stays as "mycompany.com"

### What to Whitelist

| Category | Examples |
|----------|----------|
| Own domains | `mycompany.com`, `deskagent.app` |
| Product names | `DeskAgent`, `Unity`, `OPC UA` |
| Company names | `My Company GmbH`, `Siemens` |
