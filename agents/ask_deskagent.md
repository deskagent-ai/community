---
{
  "name": "DeskAgent Hilfe",
  "category": "system",
  "description": "Beantwortet Fragen zu DeskAgent basierend auf der offiziellen Dokumentation",
  "icon": "help_center",
  "input": ":help: Frage zu DeskAgent",
  "output": ":description: Antwort mit Dokumentations-Links",
  ...
  "inputs": [
    {
      ...
      "label": "Your Question",
      "required": true,
      "placeholder": "Ask anything about DeskAgent...",
      "multiline": true,
      "rows": 4
    }
  ]
