---
{
  ...
  "description": "Erstellt Teams Meeting via Office 365 (Graph API)",
  "icon": "video_call",
  "input": ":mail: Markierte E-Mail oder :assignment: Clipboard",
  "output": ":event: Teams Meeting (Entwurf) - Prüfen in Outlook vor Versand",
  "knowledge": "^(?!linkedin)",
