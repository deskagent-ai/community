---
{
  ...
  "description": "Fasst E-Mails und Paperless-Dokumente mit einer Person/Firma zusammen",
  "icon": "summarize",
  "input": ":assignment: Clipboard / :mail: E-Mail / Firmenname",
  "output": ":analytics: Kommunikations-Zusammenfassung",
  "allowed_mcp": "outlook|msgraph|paperless|clipboard|billomat",
  "tool_mode": "read_only",
  "order": 17,
  "enabled": true
}
