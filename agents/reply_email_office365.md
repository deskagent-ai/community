---
{
  "category": "pinned|kommunikation",
  "description": "Beantwortet E-Mails mit Kategorie oder im Ordner 'ToReply' via Microsoft Graph API",
  "icon": "mark_email_read",
  "input": ":label: ToReply Kategorie / :folder: ToReply Ordner",
  "output": ":edit: Entwuerfe",
  "allowed_mcp": "msgraph|clipboard",
