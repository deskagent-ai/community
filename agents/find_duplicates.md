...
{
  "category": "system",
  "description": "Analysiert Dateien und findet Duplikate anhand von Name, Groesse und Inhalt",
  "icon": "content_copy",
  "input": ":folder_open: Dateien oder Ordner",
  "output": ":checklist: Liste der Duplikate mit Loeschoption",
  "allowed_mcp": "filesystem",
  "order": 82,
  "enabled": true,
  "anonymize": false,
  "inputs": [
    {"name": "files", "type": "file", "label": "Dateien oder Ordner", "required": true, "multiple": true, "folders": true}
  ]
}
---
